...
EnrichedMarkdownProps::EnrichedMarkdownProps(const PropsParserContext &context,
    ...
    : ViewProps(context, sourceProps, rawProps),
      ...
      enableTaskListItemToggle(
          convertRawProp(context, rawProps, "enableTaskListItemToggle", sourceProps.enableTaskListItemToggle, {true})),
      ...
      imageRequestHeaders(
          convertRawProp(context, rawProps, "imageRequestHeaders", sourceProps.imageRequestHeaders, {})),
      selectionMenuConfig(
          convertRawProp(context, rawProps, "selectionMenuConfig", sourceProps.selectionMenuConfig, {})),
      accessibilityLabels(
          convertRawProp(context, rawProps, "accessibilityLabels", sourceProps.accessibilityLabels, {})),
      textBreakStrategy(convertRawProp(context, rawProps, "textBreakStrategy", sourceProps.textBreakStrategy,
                                       {std::string{"highQuality"}})),
      lineBreakStrategyIOS(convertRawProp(context, rawProps, "lineBreakStrategyIOS", sourceProps.lineBreakStrategyIOS,
                                          {std::string{"none"}})),
      writingDirection(convertRawProp(context, rawProps, "writingDirection", sourceProps.writingDirection,
                                      {std::string{"first-strong"}})) {}
